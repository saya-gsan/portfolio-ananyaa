...
export const TAG_META: Record<string, { bg: string; color: string }> = {
...
const RAW_POSTS: Omit<BlogPost, 'slug'>[] = [
  {
...
export const POSTS: BlogPost[] = RAW_POSTS.map(p => ({ ...p, slug: slugify(p.title) }))
